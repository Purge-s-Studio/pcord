...
module.exports = {
    ...
    embedPages: async function (client, message, pages, style = []) {
        ...
        if (!pages) throw new Error("PAGES_NOT_FOUND. You didnt specify any pages to me. See Examples to clarify your doubts. In https://discord.gg/BUVtycGukk")
        if (!client) throw new Error("client not specified. See Examples to clarify your doubts. In https://discord.gg/BUVtycGukk")
    ...
    webhooks: async function (client, options = []) {
        ...
        if (!options.chid) throw new Error('EMPTY_CHANNEL_ID. You didnt specify a channel id. Go to https://discord.gg/BUVtycGukk to get support');

        if (!options.msg && !options.embed) throw new Error('Cannot send a empty message. Please specify a embed or message. Go to https://discord.gg/BUVtycGukk to get support');

        const channel = client.channels.cache.get(options.chid);

        if (!channel) throw new Error('INVALID_CHANNEL_ID. The channel id you specified is not valid (or) I dont have VIEW_CHANNEL permission. Go to https://discord.gg/BUVtycGukk to get support');
    ...
    ytNotify: async function (client, db, options = []) {
        ...
        if (!chid) throw new Error('EMPTY_CHANNEL_ID. You didnt specify a channel id. Go to https://discord.gg/BUVtycGukk to get support');
        if (!options.ytID && !options.ytURL) throw new Error('EMPTY_YT_CHANNEL_ID & EMPTY_YT_CHANNEL_URL. You didnt specify a channel id. Go to https://discord.gg/BUVtycGukk to get support');
    ...
    chatbot: async function (client, message, options = []) {
        ...
        if (Array.isArray(channel)) {
            channel.forEach((channel) => {
                ...
                if (!ch) throw new Error('INVALID_CHANNEL_ID. The channel id you specified is not valid (or) I dont have VIEW_CHANNEL permission. Go to https://discord.gg/BUVtycGukk to get support');;
            })
            ...
            if (channel.includes(message.channel.id)) {
                ...
                let developer = options.developer || 'Purge#3010'
